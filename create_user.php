...
<head>
    ...
    <title>Krabby Patties Create User Account</title>
...
<body>
    <div style="margin-top: 20px" class="container">
        <h1>Welcome, we hope to solve the worlds easiest tasks for you</h1>
        ...
        <div>
            <br>
            <a href="index.php">Click here to enter your new account!</a></br>
        </div>
